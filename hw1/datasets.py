...
def random_labelled_image(
    ...
    # ====== YOUR CODE: ======
    image = torch.randint(low=low, high=high, size=shape)
    label = int(torch.randint(low=0, high=num_classes, size=(1,)))
    # ========================
    return image, label
